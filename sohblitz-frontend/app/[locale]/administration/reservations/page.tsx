                ...
                {reservations.map((r) => (
                    ...
                    >
                        ...
                        <div className="flex justify-between items-center mb-3">
                            ...
                            <span className={`text-sm ${status(r).className} px-3 py-1 rounded-full`}>
                                {
                                    status(r).label}
                            </span>
                        </div>
                        ...
                        <div className="mt-4 flex gap-3">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg text-white transition ${r.status === "CONFIRMED"
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg text-white transition ${r.status === "CANCELED"
                                    ? "bg-gray-400 cursor-not-allowed"
